		...
		this.each(function () {
			...
			let dragbox = $(`<div class="imageuploadify well">
					<div class="imageuploadify-overlay">
						<i class="fa-duotone fa-image fa-fade"></i>
					</div>
					<div class="imageuploadify-images-list text-center">
						<i class="fa-duotone fa-cloud-arrow-up fa-8x center"></i>
			...
			const readingFile = (id, file) => {
				...
				let container = $(
					`<div class='imageuploadify-container'>
						...
						<i class="fa-duotone fa-xmark text-white"></i>
						</button>
				...
				if (file.type && file.type.search(/image/) != -1) {
					...
					let type = "<i class='fa-duotone fa-file-lines fa-fade'></i>";
					if (file.type.search(/audio/) != -1) {
						type = "<i class='fa-duotone fa-file-audio fa-fade'></i>";
					} else if (file.type.search(/video/) != -1) {
						type = "<i class='fa-duotone fa-file-video fa-fade'></i>";
					}
					fReader.onloadend = function (e) {
